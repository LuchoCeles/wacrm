...
function previewFor(step: BuilderStep): string {
  switch (step.step_type) {
    case "send_message":
      return (step.step_config.text as string) || "aún no hay texto"
    case "send_buttons":
    case "send_list":
      return interactivePayloadPreviewText(asInteractive(step.step_config)) || "aún no hay contenido"
    case "send_template":
      return (step.step_config.template_name as string) || "elegí una plantilla"
    case "wait":
