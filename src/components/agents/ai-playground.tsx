    ...
    <div className="flex h-[60vh] min-h-[420px] flex-col rounded-xl border border-border bg-card">
      ...
      <div className="flex items-center justify-between border-b border-border px-4 py-3">
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm font-medium text-foreground">Entorno de pruebas</span>
      ...
      <div ref={scrollRef} className="flex-1 space-y-4 overflow-y-auto p-4">
        {turns.length === 0 && (
          <div className="flex h-full flex-col items-center justify-center text-center text-sm text-muted-foreground">
            ...
            <p>Enviá un mensaje para ver cómo respondería tu agente.</p>
            <p className="mt-1 text-xs">
              Usa tu base de conocimiento y se comporta igual que el bot de
              respuestas automáticas, incluida la derivación a una persona.
            </p>
            {onGoToSetup && (
              <Button
                variant="link"
              ...
              >
                ¿Aún no configurado? Ir a configuración <ArrowRight className="ml-1 h-3 w-3" />
              </Button>
            )}
          </div>
        )}
      ...
      <div className="flex items-end gap-2 border-t border-border p-3">
        <textarea
          ...
          placeholder="Escribí un mensaje del cliente…"
          rows={1}
