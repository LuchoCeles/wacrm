    ...
    <div className="space-y-6">
          ...
          {headerMediaError && (
            <p className="mt-1.5 text-xs text-amber-300">
              {headerMediaError === 'missing'
                ? 'Se necesita una URL de contenido multimedia para enviar esta plantilla.'
                : 'Ingresá una URL http(s) válida.'}
            </p>
          )}
        </div>
      )}
                            ...
                            placeholder={
                              loadingFields
                                ...
                                : customFields.length === 0
                                  ...
                                  : 'Seleccioná un campo personalizado…'
                            }
                          />
                        </SelectTrigger>
                        <SelectContent className="border-border bg-popover">
      ...
      {unmappedKeys.length > 0 && (
        <div className="rounded-md border border-amber-500/30 bg-amber-500/10 px-3 py-2 text-xs text-amber-300">
          Asigná todos los marcadores antes de continuar. Aún faltan{' '}
          <span className="font-mono font-semibold">
            {unmappedKeys.join(', ')}
          </span>
          . De lo contrario, esos marcadores se enviarán a Meta como textos vacíos.
        </div>
      )}
