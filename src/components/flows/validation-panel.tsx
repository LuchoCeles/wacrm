...
export function ValidationPanel() {
  const { visibleIssues, validationVisible, requestFlash } = useFlowEditor();
  const t = useTranslations('Flows.validation');

  // A draft may contain intentionally unfinished new nodes. Keep the panel
  // quiet until the author asks to activate, rather than falsely presenting
  // the draft as ready or flooding the editor with expected errors.
