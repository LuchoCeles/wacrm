...
/** Editor-only metadata stored alongside a node's runtime config. */
export interface NodeEditorMetadata {
  /** Human-readable name shown in the editor and destination selectors. */
  node_name?: string;
}

export interface StartNodeConfig extends NodeEditorMetadata {
  /** Stable node_key of the first real node to advance to. */
  next_node_key: string;
}

export interface SendMessageNodeConfig extends NodeEditorMetadata {
...
export interface SendButtonsNodeConfig extends NodeEditorMetadata {
  text: string;
...
export interface SendListNodeConfig extends NodeEditorMetadata {
  text: string;
 ...
 */
export interface SendMediaNodeConfig extends NodeEditorMetadata {
...
export interface HandoffNodeConfig extends NodeEditorMetadata {
 ...
 */
export interface CollectInputNodeConfig extends NodeEditorMetadata {
 ...
 */
export interface ConditionNodeConfig extends NodeEditorMetadata {
...
export interface SetTagNodeConfig extends NodeEditorMetadata {
  mode: 'add' | 'remove';
...
export type EndNodeConfig = NodeEditorMetadata;
